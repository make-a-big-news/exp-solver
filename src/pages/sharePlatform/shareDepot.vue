    ...
    <mainPage>
      ...
      <template slot="main">
        <div class="container">
          ...
          <div class="form-group label-floating">
            <label class="control-label" for="focusedInput3" v-if="input.rent_want === '0'">开始出租日期</label>
            <label class="control-label" for="focusedInput3" v-else>开始租用日期</label>
            <input class="form-control" id="focusedInput3" type="date"
                   v-model.trim="input.date">
          </div>
          <div class="form-group label-floating">
            <label class="control-label" for="focusedInput4" v-if="input.rent_want === '0'">开始出租具体时间</label>
            <label class="control-label" for="focusedInput4" v-else>开始租用具体时间</label>
          ...
          <div class="form-group label-floating">
            <label class="control-label" for="focusedInput6">价格</label>
            <input class="form-control" id="focusedInput6" type="number" min="0" v-model.trim="input.price">
            <p class="help-block">请输入您可以接受的价格</p>
          </div>
          <div class="wrap">
