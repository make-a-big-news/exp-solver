...
const upDown = r => require.ensure([], () => r(require('@/pages/transportation/upDown')), 'transportation');
const uDplans = r => require.ensure([], () => r(require('@/pages/transportation/uDplans')), 'transportation');
